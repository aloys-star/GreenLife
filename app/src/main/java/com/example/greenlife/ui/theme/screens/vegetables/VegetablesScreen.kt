package com.example.greenlife.ui.theme.screens.vegetables
...
@Composable
fun VegetablesScreen(navController: NavController){
    Column(
        modifier = Modifier
            .fillMaxSize()
            ) {
                ...
                Column(
                    ...
                    Card (modifier = Modifier
                        ...
                        Box(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.capsicum),
                                contentDescription = "null",
                                modifier = Modifier.fillMaxSize(),
                                contentScale = ContentScale.Crop
                            )
                    ...
                    Card (modifier = Modifier
                        ...
                        Box(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.sweetpotatoes),
                                contentDescription = "null",
                                modifier = Modifier.fillMaxSize(),
                                contentScale = ContentScale.Crop
                            )
                    ...
                    Card (modifier = Modifier
                        ...
                        Box(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.potatoes),
                                contentDescription = "null",
                                modifier = Modifier.fillMaxSize(),
                                contentScale = ContentScale.Crop
                            )
                        ...
                        Box(
                            ...
                            Row(modifier = Modifier.align(Alignment.BottomStart)) {
                                Column(
                                    ...
                                    Text(
                                        text = "Climate : Temprate And Semi-arid",
                                        fontSize = 19.sp,
                                        fontWeight = FontWeight.Bold,
                                        fontFamily = FontFamily.Default,
                                        color = Color.White,
...
fun VegetablesScreenPreview(){
    VegetablesScreen(rememberNavController())
}
